...
export const UpdateGroupChatModal = ({ fetchagain, setFetchagain ,fetchMessages}) => {
    ...
    const handleRemove = async(user1) => {
         ...
         try {
            ...
            const { data } = await axios.put("https://blinkchat-five.vercel.app/api/chat/removegroup",{
    ...
    const handleRename = async () => {
        ...
        try {
            ...
            const { data } = await axios.put("https://blinkchat-five.vercel.app/api/chat/rename", {
    ...
    const handleSearch = async (query) => {
        ...
        try {
            ...
            const { data } = await axios.get(`https://blinkchat-five.vercel.app/api/user?search=${search}`, config);
    ...
    const handleAddUser = async (user1) => {
        ...
        try {
            ...
            const { data } = await axios.put("https://blinkchat-five.vercel.app/api/chat/addgroup",{
                chatId : selectedChat._id,
                userId : user1._id,
            }, config);
